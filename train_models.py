...
def get_datasets(
    ...
    data_train = DetectionDataset(
        ...
        wavefake_path=datasets_paths[1] if len(datasets_paths) > 1 else None,
        fakeavceleb_path=datasets_paths[2] if len(datasets_paths) > 2 else None,
        asvspoof2019_path=datasets_paths[3] if len(datasets_paths) > 3 else None,
        subset="train",
